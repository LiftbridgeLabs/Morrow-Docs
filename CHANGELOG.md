...
- Sync between your Apple devices, including Apple TV: your Up Next list, the books you have swiped off Continue Listening, and your recently played list all follow you, so a change made on one device shows up on the others while they are open. Uses your own private iCloud database, and is covered by the same "Sync Servers and Up Next" setting as the server backup
